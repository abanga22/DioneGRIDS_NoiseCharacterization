...
% Read the data file for C3 20nA on Upsweep
fileName = "GRIDS_DIONE_CALIBRATION_12082022_3_C_20nA_U.xlsx";
...
title("Distribution of Collector C Currents with 20 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("QQ Plot of Collector C Current with 20 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("Moving Average of Collectors A, B, and D Currents for 20 nA Stimulation on Collector C");
...
disp("Unstimulated collector currents for 20 nA on Coll. C: ");

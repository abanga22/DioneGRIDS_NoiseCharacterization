...
% Read the data file for C2 1nA on Upsweep
fileName = "GRIDS_DIONE_CALIBRATION_12142022_2_B_1nA_U.xlsx";
...
title("Distribution of Collector B Currents with 1 nA Stimulation", FontSize=20);
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("QQ Plot of Collector B Current with 1 nA Stimulation", FontSize=20);
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("Moving Average of Collectors A, C, and D Currents for 1 nA Stimulation on Collector B", FontSize=20);

...
% Read the data file for C1 10nA on Upsweep
fileName = "GRIDS_DIONE_CALIBRATION_12132022_1_A_10nA_U.xlsx";
...
title("Distribution of Collector A Currents with 10 nA Stimulation", FontSize=20);
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("QQ Plot of Collector A Current with 10 nA Stimulation", FontSize=20);
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("Moving Average of Collectors B, C, and D Currents for 10 nA Stimulation on Collector A", FontSize=20);
...
disp("Unstimulated collector currents for 10 nA on Coll. A: ");
...
minusTwoSigma = meanC1Current - 2*stdC1Current;
plusTwoSigma = meanC1Current + 2*stdC1Current;
disp(strcat("Mean Current (nA): ", num2str(meanC1Current)));

...
% Read the data file for C4 20nA on Upsweep
fileName = "GRIDS_DIONE_CALIBRATION_12142022_4_D_20nA_U.xlsx";
...
title("Distribution of Collector D Currents with 20 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("QQ Plot of Collector D Current with 20 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("Moving Average of Collectors A, B, and C Currents for 20 nA Stimulation on Collector D");
...
disp("Unstimulated collector currents for 1 nA on Coll. D: ");
...
minusTwoSigma = meanC4Current - 2*stdC4Current;
plusTwoSigma = meanC4Current + 2*stdC4Current;
disp(strcat("Mean Current (nA): ", num2str(meanC4Current)));

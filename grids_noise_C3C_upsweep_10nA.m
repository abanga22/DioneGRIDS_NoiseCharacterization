...
% Read the data file for C3 10nA on Upsweep
fileName = "GRIDS_DIONE_CALIBRATION_12082022_3_C_10nA_U.xlsx";
...
title("Distribution of Collector C Currents with 10 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("QQ Plot of Collector C Current with 10 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("Moving Average of Collectors A, B, and D Currents for 10 nA Stimulation on Collector C");
...
disp("Unstimulated collector currents for 10 nA on Coll. C: ");

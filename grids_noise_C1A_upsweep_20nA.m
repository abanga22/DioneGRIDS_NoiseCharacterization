...
% Read the data file for C1 20nA on Upsweep
fileName = "GRIDS_DIONE_CALIBRATION_12132022_1_A_20nA_U.xlsx";
...
hold on;
meanLine = xline(meanC1Current, "-r", {"\mu", "= " + num2str(meanC1Current) + " nA"});
meanLine.LabelOrientation = "horizontal";
meanLine.FontWeight = 'bold';
hold on;
plusOneStdDev = xline(meanC1Current + stdC1Current, "-b", {"\mu + \sigma", "= " + num2str(meanC1Current + stdC1Current) + " nA"});
plusOneStdDev.LabelOrientation = "horizontal";
plusOneStdDev.FontWeight = 'bold';
hold on;
minusOneStdDev = xline(meanC1Current - stdC1Current, "-b", {"\mu - \sigma", "= " + num2str(meanC1Current - stdC1Current) + " nA"});
...
title("Distribution of Collector A Currents with 20 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("QQ Plot of Collector A Current with 20 nA Stimulation");
...
set(gca, 'XMinorGrid', 'on', 'YMinorGrid', 'on', ...
         'GridColor', 'k', 'MinorGridAlpha', 0.4, 'MinorGridLineStyle', '-', ...
         'MinorGridColor', [0.3,0.3,0.3], 'GridAlpha', 0.4, 'LineWidth', 1.2);
title("Moving Average of Collectors B, C, and D Currents for 20 nA Stimulation on Collector A");

...
disp("Unstimulated collector currents for 100 nA on Coll. B: ");
...
minusTwoSigma = meanC2Current - 2*stdC2Current;
plusTwoSigma = meanC2Current + 2*stdC2Current;
disp(strcat("Mean Current (nA): ", num2str(meanC2Current)));
